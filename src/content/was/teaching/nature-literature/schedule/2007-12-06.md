...
<img src="./humors.png" alt="a grid associating the following list of humors based on hot and cold versus dry and moist">

Yellow Bile
  ~ "choleric"
  ~ hot / dry
  ~ associated with **_fire_**, violence, and vengeance

Blood
  ~ "sanguine"
  ~ hot / moist
  ~ associated with **_air_**, love, happiness, and generosity

Black Bile
  ~ "melancholic"
  ~ cold / dry
  ~ associated with **_earth_**, gluttony, laziness, and sentimentality

Phlegm
  ~ "phlegmatic"
  ~ cold / moist
  ~ associated with **_water_**, dullness, paleness, and cowardice
